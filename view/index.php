            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="<?php echo ASSETS_URL."images/unicordoba_logo1.png"?>" width="80%" alt="logo" /></span>
                    </div>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" action="<?php echo ABS_PATH."user/signin"?>" method="POST">
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input name="email" type="text" class="form-control form-control-lg" placeholder="Usuario" aria-label="Username" aria-describedby="basic-addon1" required="">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        ...
                                        <a href="user/nuevo" class="btn btn-dark float-right">Registrar</a>
                ...
                <div id="recoverform">
                    ...
                    <div class="row m-t-20">
                        <!-- Form -->
                        <form class="col-12" action="<?php echo ABS_PATH."user/recoverypass"?>" method="POST">
                            <!-- email -->
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
